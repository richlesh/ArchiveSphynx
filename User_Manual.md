...
ArchiveSphynx is a cross-platform desktop archive management tool for macOS, Windows, and Linux.
...
If the bzip2 command-line tool is not available, ArchiveSphynx may use a slower JavaScript fallback and show a performance warning.
...
ArchiveSphynx could not find the bzip2 command-line tool and used a slower fallback. Install bzip2 or configure its path in Settings.
