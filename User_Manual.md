...
- [ArchiveSphinx User Manual](#archivesphinx-user-manual)
  ...
  - [Supported Archive Formats](#supported-archive-formats)
    - [Open / Browse Formats](#open--browse-formats)
  ...
  - [Creating a New Archive](#creating-a-new-archive)
    - [New Archive Save Formats](#new-archive-save-formats)
  - [Opening an Archive](#opening-an-archive)
  - [Browsing Archive Contents](#browsing-archive-contents)
  ...
  - [Adding Files and Folders](#adding-files-and-folders)
    - [Adding to a Specific Folder](#adding-to-a-specific-folder)
    - [File Size Note](#file-size-note)
  - [Creating Folders](#creating-folders)
  - [Renaming Entries](#renaming-entries)
  - [Moving and Reordering Entries](#moving-and-reordering-entries)
    - [Move an Entry](#move-an-entry)
    - [macOS Metadata Movement](#macos-metadata-movement)
  - [Deleting Entries](#deleting-entries)
  - [Extracting Files](#extracting-files)
    - [Extract All](#extract-all)
    - [Extract Selected](#extract-selected)
  - [Saving Archives](#saving-archives)
  - [Save As and Format Conversion](#save-as-and-format-conversion)
  - [Testing Archive Integrity](#testing-archive-integrity)
  - [Cleaning macOS Metadata](#cleaning-macos-metadata)
  - [Settings](#settings)
  - [Helper Compression Tools](#helper-compression-tools)
    - [gzip / pigz](#gzip--pigz)
    - [bzip2](#bzip2)
    - [xz](#xz)
    - [zstd](#zstd)
    - [7-Zip](#7-zip)
    - [Configuring Tool Paths](#configuring-tool-paths)
  - [Read-Only Formats](#read-only-formats-1)
  - [License Key and Donation Prompt](#license-key-and-donation-prompt)
  - [Troubleshooting](#troubleshooting)
    ...
    - [Drag and drop does not add files](#drag-and-drop-does-not-add-files)
    - [Files were skipped while adding](#files-were-skipped-while-adding)
    - [A window will not close](#a-window-will-not-close)
...
Build targets include x64 and ARM64.
...
3. Click **Add** or choose **File → Add files…** to add files or folders.  Optionally you can drag and drop files/folders onto the archive window.
